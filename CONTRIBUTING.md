...
## 1 Fork 代码
1. 访问 https://github.com/ego-component/emongo
...
```bash
git clone https://github.com/ego-component/emongo.git
cd emongo
git remote add upstream 'git@github.com:<your github username>/emongo.git'
```
...
## 6 提交 PR
访问 https://github.com/ego-component/emongo, 
